...
const CalendarCard = () => {
  ...
  // Dynamic Calendar Day Generation
            ...
            >
              <div className="text-right flex flex-col items-end">
                  ...
                  <div className="flex items-center gap-4 mb-2 group">
                      <button onClick={() => changeYear(-1)} className="p-1 rounded-full hover:bg-white/10 transition-colors opacity-40 group-hover:opacity-100">&lt;</button>
                      <p className="text-xl font-bold tracking-tight opacity-70 mb-0">{viewDate.getFullYear()}</p>
                      <button onClick={() => changeYear(1)} className="p-1 rounded-full hover:bg-white/10 transition-colors opacity-40 group-hover:opacity-100">&gt;</button>
                  </div>
                  
                  {/* Month Navigation */}
                  <div className="flex items-center gap-2 group">
                      <button onClick={() => changeMonth(-1)} className="text-2xl p-2 rounded-full hover:bg-white/10 transition-colors opacity-40 group-hover:opacity-100">&lt;</button>
